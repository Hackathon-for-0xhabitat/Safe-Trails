          ...
          >
            <div>
              ...
              <div className="flex justify-center">
                       <button class="flex items-center px-2 py-2  transition ease-in duration-200 uppercase rounded hover:bg-gray-800 text-red-500 hover:text-white border-2 border-gray-4P00 focus:outline-none" onClick={selectedClicked}>
                  <svg
                ...
                {/* onClick={() => setDownVote(downVote - 1) */}
                       <button class="flex items-center px-2 py-2  mx-2 transition ease-in duration-200 uppercase rounded hover:bg-gray-800 text-black  hover:text-white border-2 border-gray-400 focus:outline-none" onClick={selectedClicked}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-6 w-6"
                    fill="none"
